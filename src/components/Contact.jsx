...
// создание формы для отправки обратной связи внутреняя часть
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "JavaScriptDeveloper",
          from_email: form.email,
          to_email: "sss.javascriptdeveloper.com",
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="Какой ваш web адресс?"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
